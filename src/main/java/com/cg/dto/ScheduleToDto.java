...
public class ScheduleToDto {
	public static RouteScheduleDto mapToDto(RouteSchedule schedule) {
		...
		return new RouteScheduleDto(schedule.getId(), schedule.getDepartureTime(), schedule.getScheduleDate(), schedule.getTotalSeats(),
				schedule.getAvailableSeats(), dto, schedule.getBookedSeats());
